...
namespace OrmTest.LightDataTest
{
    class Program
    {
        ...
        static void Test(string[] args)
        {
            ...
            DataContext context1 = new DataContext(db);
            ...
            List<TeBaseField> datalist = new List<TeBaseField>();
            {
                ...
                for (int i = 0; i < list.Count; i++) {
                    var item = list[i];
                    DataContext context = new DataContext(db);
            ...
            List<TeBaseField> totalList = new List<TeBaseField>();
            {
                ...
                for (int i = 0; i < round; i++) {
                    ...
                    count += res;
                    Console.WriteLine($"insert round {i + 1}, item {res}, spend time {(DateTime.Now - d2).TotalSeconds} seconds");
                    temp.AddRange(list);
                }
